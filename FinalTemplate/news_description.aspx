<%@ Page Title="News Description" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="news_description.aspx.cs" Inherits="FinalTemplate.news_description" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="UserContentPlaceHolder" runat="server">
    ...
    <div class="section background-opacity page-title set-height-top">
                    <div class="container">
                        <div class="page-title-wrapper"><h2 class="captions">news &nbsp; Description</h2>
                            <ol class="breadcrumb">
    ...
    <div class="section section-padding news-detail">
                    <div class="container">
                        <div class="group-title-index"><h4 class="top-title">Some Description</h4>

                            <h2 class="center-title">You Have To Know About This News</h2>
                                ...
                                <div class="col-md-3 col-sm-12 sidebar layout-right">
                                    <div class="row">
                                        ...
                                        <div class="share-widget widget col-sm-6 col-md-12 col-xs-6 sd380">
                                            ...
                                            <div class="content-widget">
                                                <div class="socials social-widget"><a href="#" class="link facebook"><i class="fa fa-facebook"></i></a><a href="#" class="link google"><i class="fa fa-google-plus"></i></a><a href="#" class="link twitter"><i class="fa fa-twitter"></i></a></div>
                                            </div>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
