<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher.Master" AutoEventWireup="true" CodeBehind="Teacher_Events.aspx.cs" Inherits="FinalTemplate.Teacher_Events" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="TeacherPlaceHolder1" runat="server">
    ...
    <input id="schoolIDvalue" type="hidden" value="<%=teacher.schoolid%>" />
