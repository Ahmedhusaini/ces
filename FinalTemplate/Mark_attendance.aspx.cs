...
namespace FinalTemplate
{
    public partial class mark_attendance : System.Web.UI.Page
    {
        ...
        {
            var sValue3 = GridView1.SelectedRow.Cells[1].Text;
            ...
            int remark_id = Convert.ToInt32(db.GetLastValueByColumnName("remark_id", "tbl_remarks"));
            ...
            using (SqlConnection con = new SqlConnection(a))
            {
                ...
                cmd.Parameters.AddWithValue("@remark_id", SqlDbType.VarChar).Value = remark_id;
                cmd.Parameters.AddWithValue("@remark_id_out", SqlDbType.VarChar).Direction = ParameterDirection.Output;
                ...
                cmd.Parameters.AddWithValue("@remarks", SqlDbType.VarChar).Value = sValue3;
