...
{
    public partial class UpdateParentPassword : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session["userid"] != null)
            {
                ...
                string[,] studentid = myDatabase.SelectQuery("tbl_Parents", col, colwhere, whereoperator, whereoperatorvale, multiwhere);
        ...
        public void sendmail()
        {
            ...
            mmsg.Body = "Hllo  " + username.Text + "</br> This is your updated password : " + newpassword.Text;
