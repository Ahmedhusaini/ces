...
namespace FinalTemplate
{
    public partial class parentpanel1 : System.Web.UI.Page
    {
        ...
        protected void butview(object sender, EventArgs e)
        {
        ...
        {
            Response.Redirect("~/Parents_view_child.aspx?ID=" + ((LinkButton)sender).Text);
        ...
        protected void OnRowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                //e.Row.Attributes["onclick"] = ClientScript.(this.GridView1, "Select$" + e.Row.RowIndex);
                ////Server.Transfer("~/Parents_view_child.aspx");
